...
You may also use other tools such as LaTeX, Canva, PowerPoint or any software you are comfortable with.

This template is adapted from the GitHub repository *postr* by François Rozet: https://github.com/francois-rozet/postr
